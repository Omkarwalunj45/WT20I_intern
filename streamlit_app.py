...
pdfn['bowler'] = pdfn['bowler'].replace('AC Jayangini', 'Chamari Athapaththu')
pdfn['batsman'] = pdfn['batsman'].replace('AC Jayangini', 'Chamari Athapaththu')
pdfn['non_striker'] = pdfn['non_striker'].replace('AC Jayangini', 'Chamari Athapaththu')
idf = pd.read_csv("Dataset/lifesaver_bat.csv",low_memory=False)
idf['batsman'] = idf['batsman'].replace('AC Jayangini', 'Chamari Athapaththu')
...
bpdfn['bowler'] = bpdfn['bowler'].replace('AC Jayangini', 'Chamari Athapaththu')
bpdfn['batsman'] = bpdfn['batsman'].replace('AC Jayangini', 'Chamari Athapaththu')
bpdfn['non_striker'] = bpdfn['non_striker'].replace('AC Jayangini', 'Chamari Athapaththu')
bidf=pd.read_csv("Dataset/lifesaver_bowl.csv",low_memory=False)
bidf['bowler'] = bidf['bowler'].replace('AC Jayangini', 'Chamari Athapaththu')
