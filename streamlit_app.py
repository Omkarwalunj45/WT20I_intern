...
# If "Matchup Analysis" is selected
    ...
    with right_col:
        ...
        # # Function to apply small random offset
        ...
        #     # Apply random offset for each ball at the same line and length
        #     x_pos = apply_offset(x_base)
        #     y_pos = apply_offset(y_base)
        #     z_pos = 0  # Ground level, on pitch surface
        
        #     # Set color based on is_wkt and batsman_runs
        #     if row['is_wkt'] == 1:
        #         color = 'red'  # Wicket color
        #     else:
        #         # Color based on batsman_runs when not a wicket
        ...
        #             color = 'brown'
        #         else:
        #             color = 'gray'  # Default color for other run values if any
        
        #     # Plot the scatter point
        #     fig.add_trace(go.Scatter3d(
        #         x=[x_pos],
        #         y=[y_pos],
        #         z=[z_pos],  # Position on the ground
        #         mode='markers',
        ...
        #         zaxis=dict(title='Z-axis (Height)', range=[0, 1]),  # Limit z-axis to keep balls on pitch
        #     ),
        #     width=700,
        #     height=800,
        #     showlegend=False
        ...
        # def apply_offset(value, offset_range=(-0.45, 0.45)):
        #     return value + np.random.uniform(offset_range[0], offset_range[1])
        ...
        # # Add stumps and bails (similar to the previous code)
        ...
        #     # Apply random offset to both x and y positions
        #     x_pos = apply_offset(x_base)
        #     y_pos = apply_offset(y_base)
        ...
        def apply_offset(value, offset_range=(-0.15, 0.65), boundary=(-0.5, 0.5)):
